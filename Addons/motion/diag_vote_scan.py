...
def main():
    ...
    ax[3].plot(T, R['vote_moving'], drawstyle='steps-mid', color='purple', lw=1.8, label=f"vote ({res['vote_v1']['freeze_precision']}% frz-prec)")
    ...
    ax[3].set_title(f"decisions -- GT agreement: old {res['old']['gt_agree']}% vs VOTE {res['vote_v1']['gt_agree']}%")
