...
C2/001 serves as an example in Figure~\ref{fig:example_sequence}, showing the frames, semantic ground truth, MoGe-2 depth maps, and ground-truth trajectories included in every data sequence.
\begin{figure}[!ht]
    \centering
