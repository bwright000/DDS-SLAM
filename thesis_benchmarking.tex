...
$|r|_{\mathrm{dom}}$ \\
\midrule
C1\_001 &  360 & \multicolumn{4}{c}{\emph{in progress}} \\
C2\_001 &  730 & \multicolumn{4}{c}{\emph{in progress}} \\
C3\_001 & 1527 & \multicolumn{4}{c}{\emph{in progress}} \\
E3\_005 &  265 & \multicolumn{4}{c}{\emph{in progress}} \\
G3\_001 & 1987 & \multicolumn{4}{c}{\emph{in progress}} \\
\bottomrule
\end{tabular}
\end{table}

% TODO on results: PERSEUS is the strongest dedicated tracker in the table by
% design lineage; the interesting outcome either way --- if it leads, it sets
% the tracking bar for the render-capable systems; if it over-travels or
% loses lock on the sub-SNR mm-scale motion, that failure is evidence that
% CRCD's regime defeats even flow-based dense BA, strengthening the
% sub-SNR analysis of Section~\ref{sec:bench_summary}.
